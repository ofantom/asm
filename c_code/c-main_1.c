...
extern void move_char_to_int();
extern void revers_password(char *mAs, long password);
void longArray(long int* arr); //extern не обязателен
char text[5] = "nelej";
long mas[] = { 33, 44, 55, 66 };
char charChar[2] = { -5, 15 };
int IntInt[2];
long password = 0x70617373776f7264;
char mAs[8];
