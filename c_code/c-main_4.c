...
int g_int_pole[10] = {11111,22222,33333,44444,55555,66666,77777,88888,99998,10000};
extern void sum_bytes();


int stepen = 1;
int g_int_pocet = 2;
int g_int_pole2[10] = {10,16,30,41,50,61,70,80,90,11};
int g_int_counter = 0;
extern int kratnost();
